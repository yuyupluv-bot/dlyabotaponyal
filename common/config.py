...
class Config:
    ...
    PASSENGER_POLL_TIMEOUT: int = int(_get("PASSENGER_POLL_TIMEOUT", "60"))
    ...
    # Default 60 seconds. The live value remains editable in the admin panel
    # through the ``driver_accept_timeout`` setting.
    DRIVER_ACCEPT_TIMEOUT: int = int(_get("DRIVER_ACCEPT_TIMEOUT", "60"))
    DRIVER_CHAT_TIMEOUT: int = int(_get("DRIVER_CHAT_TIMEOUT", "2700"))
