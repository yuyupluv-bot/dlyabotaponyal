...
from bot import away_order_notice_service, booking_service, dispatcher_report_service, maintenance_service, order_service, outbox_service, passenger_queue, temporary_driver_service
...
def run() -> None:
    ...
    dispatcher_report_service.start_worker()
