...
class States:
    ...
    P_DRIVER_SELECT = "passenger_driver_select"
    P_DIRECT_TEXT = "passenger_direct_driver_text"
    ...
    # «Отправить отчет водителям»: photo + text in one message.
    DISP_REPORT_INPUT = "dispatcher_report_input"
